...
int main(int argc, char* argv[]) {
  ...
  int num_vertices = 1632803;
	...
	// string partition_filename1("../input/pokec/pokec-rr-partition-map-4-3.txt");  // MIC-only.
	// string partition_filename1("../input/pokec/pokec-blk-partition-map-4-3.txt");  // MIC-only.
	// string partition_filename1("../input/pokec/pokec-hybrid-partition-map-4-3.txt");  // MIC-only.
