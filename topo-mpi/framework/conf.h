...
#define buffer_block_size 5 
// Used for dynamic scheduling for msg generation.
#define vertex_block_size 10 
#define update_vertex_block_size 10 
...
#define vlen 16
#define nthread 32 
#define reduce_thread 16  // This is the optimun number different from nthread.
#define update_thread 16  // This is the optimun number different from nthread.
#define status_count_thread 16 // This is the optimun number different from nthread.
#define compute_size_thread 16 // This is the optimun number different from nthread.
#define msg_sender_thread 1 // For parallel msg sending stage.
#define msg_receiver_thread 1 // For parallel msg receiving stage.
#define msg_inserter_thread 16 // For parllel msg insertion stage.
...
#define vertices_per_buffer 128 
#define vertices_per_array (vlen/4)
...
#define buffer_block_size 5 
// Used for dynamic scheduling for msg generation.
#define vertex_block_size 5 
#define update_vertex_block_size 10 
// Used for parallel sending of remote messages.
#define remote_buffer_block_size 10
