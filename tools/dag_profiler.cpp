...
int main() {
  ...
  */
  ...
  string filename("/work/02687/binren/graph/code/input/dag/dag.txt");
  graph<float, float>* g = ReadGraph<float, float>(89778, filename);
  cout << "Read done." << endl;
  WriteInDegreeHistgram(g, "/work/02687/binren/graph/code/input/dag/dag-indegree-histgram.txt");
  cout << "Write done." << endl;
